...
ReceivedSocketData Server::accept()
{
...
void Server::receiveData(ReceivedSocketData &ret, bool blocking)
{
	int iResult;
...
int Server::sendReply(ReceivedSocketData reply)
{
	int iSendResult;
...
int Server::closeClientSocket(ReceivedSocketData &reply)
{
	int iResult;
